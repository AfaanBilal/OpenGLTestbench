...
namespace test
{
	...
	{
		Vertex verticies[] = {
			{ { -0.5f, -0.5f }, { 0.1f, 0.8f, 0.8f, 1.0f }, { 0.0f, 0.0f } },
			{ {  0.5f, -0.5f }, { 0.1f, 0.8f, 0.8f, 1.0f }, { 1.0f, 0.0f } },
			{ {  0.5f,  0.5f }, { 0.1f, 0.8f, 0.8f, 1.0f }, { 1.0f, 1.0f } },
			{ { -0.5f,  0.5f }, { 0.1f, 0.8f, 0.8f, 1.0f }, { 0.0f, 1.0f } },
		};
